...
public class BuscarEst {
	...
	public static void main(String[] args) {
		...
		try {
			/*INI: BUSCAR TODOS LOS ESTUDIANTES******/
			System.out.println("-------LISTA DE TODOS LOS ESTUDIANTES-----");
			p.buscarTodos();
			/* FIN: BUSCAR TODOS ESTUDIANTES***********/
			
			/*INI : BUSCAR ESTUDIANTE POR ID ***********/
			System.out.println("-----------CROMPROBACION DE ESTUDIANTES-----------");
			p.buscarEstudianteById(1);
			p.buscarEstudianteById(3);
			p.buscarEstudianteById(8);
			/*FIN: BUSCAR ESTUDIANTE PÓR ID*****/
		}
		catch (Exception e) {
			e.printStackTrace();	
		}
